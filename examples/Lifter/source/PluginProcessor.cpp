...
// =========== PARAMETER LAYOUT ====================
juce::AudioProcessorValueTreeState::ParameterLayout CompressorProcessor::createParams()
{
...
{
    compressor.updateRatio( apvts.getRawParameterValue(Parameters::ratioId)->load() );
    compressor.updateThres( apvts.getRawParameterValue(Parameters::thresId)->load() );
    compressor.updateKnee( apvts.getRawParameterValue(Parameters::kneeId)->load() );
    
    compressor.updateAttack( apvts.getRawParameterValue(Parameters::attackId)->load() );
    compressor.updateRelease( apvts.getRawParameterValue(Parameters::releaseId)->load() );
    
    compressor.updateMakeUp( apvts.getRawParameterValue(Parameters::makeupId)->load() );
    
    compressor.updateFeedForward ( (bool) apvts.getRawParameterValue(Parameters::feedId)->load() );
    
    compressor.updateMix( apvts.getRawParameterValue(Parameters::mixId)->load() );
}
